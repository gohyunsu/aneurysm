...
class AneumoP0V3ActivationTests(unittest.TestCase):
    ...
    def test_wrapper_calls_v3_activation_and_forbids_gpu_other_server(self) -> None:
        ...
        self.assertIn('runtime_wheel_name="${AURORA_RUNTIME_WHEEL##*/}"', text)
        self.assertIn('/runtime-wheel/$runtime_wheel_name', text)
        self.assertNotIn('/runtime-wheel/h5py.whl', text)
