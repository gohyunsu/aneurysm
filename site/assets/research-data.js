  ...
  lineage: [
    {
      ...
      copy: "At the pinned official revision, all 730 transient directories expose the seven documented filenames. The exact processed-v4 object nevertheless contains fewer than 700 registered cases. Official code shows that 1k is formatted from n_subdivide=1 rather than cohort size, enforces no 730-case assertion, can reuse existing mesh and assembled caches, and uses a non-lineage serialized-order split. This proves processed/raw cardinality drift but not the missing IDs or historical build cause. The user subsequently selected a fresh threshold-free metadata-only D4 census; it is registered at attempt 0/1 without changing D3.",
      status: "Static S0 complete · D4 selected/registered at attempt 0/1 · exact count and IDs remain unread pending Quality/private activation · science/model/GPU/claim 0",
