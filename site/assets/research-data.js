window.AURORA_DATA = Object.freeze({
  ...
  lineage: [
    {
      ...
      copy: "At the pinned official revision, all 730 transient directories expose the seven documented filenames. The exact processed-v4 object contains 578 registered cases. Official code shows that 1k is formatted from n_subdivide=1 rather than cohort size, enforces no 730-case assertion, can reuse existing mesh and assembled caches, and uses a non-lineage serialized-order split. D4 closes complete 1/1 and confirms uniform 80×13,902×9 tensors plus exact mesh order, but only 168 IDs directly link to the current geometry root. This resolves cardinality without resolving lineage or the remaining 410 geometry links.",
      status: "D4 complete · 578 cases · 168 geometry-linked / 410 unresolved · scientific verdict null · candidate 31.0/40 inactive",
    ...
    },
    {
      ...
      copy: "The closed response-fidelity P0 is not repaired. A fresh direct-prior subtraction includes Hodge Spectral Duality, SE(3) artery-wall WSS networks, RHSIA, exact critical-point-trajectory compression, FaCTz and a 359-lesion aneurysm critical-point study. GNN, Hodge, edge 1-forms, temporal decoding, tracking and topology losses are therefore controls rather than novelty. The remaining application conjunction is robust target identification, field-error/compute-matched structural failure and a minimal mechanism-linked correction. It stays 30.0/40 inactive. D0 reuses only case 1 phases 4.01 and 5.00. V1 job 116160.ECE-util1 ended execution-incomplete before any VTP payload because compute-node networking was unreachable. Final v2 job 116165.ECE-util1 used exact ephemeral private staging, zero PBS HTTP and GPU 0, completed in 25 seconds and deleted the raw stage. Detailed field-derived aggregate remains private. Scientific stability is still unevaluated. P0 v1 staged zero of 60 fields and was withdrawn after an official mapping-integrity audit found that the latest partial Connection.csv correction still conflicts with the owner's own error acknowledgement and precedes the promised full review. The separate licence conflict also remains. Closed response-fidelity P0 v3 remains execution-incomplete with 0/12 scientific checks evaluated. No successor P0, model or claim is active.",
      status: "Active paper identity 0 · transient 30.0/40 inactive · D0 v2 complete / stability unevaluated · P0 v1 withdrawn at field 0/60 · model/GPU/test/claim 0",
      url: "../docs/aneumo-transient-structure-reentry-2026-08-13.md"
    },
    {
      year: "2026.08",
      title: "Stability P0 v1 is withdrawn before field access",
      copy: "V1 field-blindly froze 12 non-D0 families and five phases, but staged zero of 60 members. Official issue 4 records the owner's acknowledgement that cases 2158 and 2159 belong to family 115 and a later promise to review the entire mapping. The latest main is the earlier partial correction and still assigns case 2158 to family 114. The known row lies outside transient 1–1000, so no selected row is declared wrong; nevertheless the promised full review is absent and the family inference unit is not authoritative. Together with the independent HF/GitHub licence conflict, this withdraws v1 permanently. A successor requires both resolutions and a fresh prospective selection.",
      status: "Withdrawn before field access · staged/read 0/60 · current panel cannot reactivate · successor unregistered",
      url: "../docs/aneumo-connection-mapping-integrity-audit-2026-08-13.md"
    },
    {
      year: "2026.08",
    ...
    },
    {
      ...
      copy: "Exact scientific public source 8b288c0… passed Quality 31601736993 and Pages 31601736273. Private planning head 83fc8861… is remote exact, PRIVATE and anonymously returns 404; manuscript and reference bytes remain unchanged. The live site exposes duplicate-free matching, median co-primary screening and the cross-fit no-inference boundary. This creates no real P0 result, P1 registration, model, GPU, outer test or paper claim.",
      status: "Public CI/Pages success · private remote exact/anonymous 404 · manuscript unchanged · real P0 0/11",
      url: "../docs/isbi-2027-plan.md"
    },
    {
    ...
    },
    {
      ...
      copy: "The fresh source screen remains 32.5/31.0/29.5/29.5/29.0/28.5, but the leader is no longer active. Exact introai9 CPU/PBS job 115684 ended E/exit 2 after 00:40:06 and produced only a bounded execution-incomplete/no-verdict result. Complete archive integrity and VTP semantics were not reported, transient partial bytes are unknown, and 0/10 scientific checks were evaluated. The 32.5 score is source history, not a method or negative result. No repair, rerun, P1, architecture, GPU or outer test is authorized.",
      status: "32.5/40 source history · P0 E/exit 2 · 0/10 no verdict · active lead/method/GPU/claim 0",
    ...
    },
    {
      ...
      copy: "OpenNeuro ds003949 and the official code reconcile 284 public subjects into 246 weak-label and 38 precise-label subjects after excluding four code-only weak subjects. The formulation uses only Y ⊆ W and never treats the weak sphere as truth. Its exact introai9 CPU P0 finished F/exit 1 with only a 310-byte incomplete status: no aggregate or raw log exists, so 0/10 registered checks have a verdict. The 32.5/40 source finding is preserved as closed history, neither novelty nor a negative scientific result.",
      status: "Closed P0 history · execution-incomplete/no verdict · active lead/P1/method/architecture/GPU 0",
  ...
  gates: [
    ...
    },
    {
      ...
      copy: "One exact introai9 CPU/PBS metadata audit was registered to check the 5,737-path tree, 284 public subjects, 296 manual-mask subject-session paths, 494 mask paths, safe opcode-only parsing, the 246+38 partition, subject-only joining and licenses. It finished before an aggregate materialized, leaving all ten checks unevaluated. No NIfTI body, participant/clinical table, model, checkpoint, GPU or outer test was accessed.",
      state: "Closed · F/exit 1 · 0/10 checks · no scientific verdict · no repair/rerun/P1/model/GPU",
      blocking: true
    },
    {
      id: "P0-BC",
  ...
  changes: [
    {
      date: "2026.08.16",
      category: "data",
      title: "D4 closes complete and identifies the exact 578-case processed cohort",
      copy: "The sole introai9 CPU 4/64 GB/GPU-0 job 116482 finalizes F/exit 0 in 00:01:56 after rechecking both exact objects. The snapshot contains 578 unique cases with uniform 80×13,902×9 float32 tensors, vector-WSS labels and exact mesh order. Only 168 IDs directly match the current geometry root, leaving 410 unresolved. Ordered IDs and raw logs remain private. D4 is closed 1/1 with scientific_verdict=null; human rescore stays 31.0/40 inactive and opens no split, P0, model or claim.",
      files: ["results/aneug_processed_v4_d4_census_20260816.json", "results/aneug_processed_v4_d4_execution_20260816.json", "configs/aurora_v1.json", "src/aurora/protocol.py", "tests/test_protocol.py", "README.md", "site/index.html", "site/learn.html", "site/assets/research-data.js", "AGENTS.md", "CHANGELOG.md"]
    },
    {
      date: "2026.08.16",
      category: "protocol",
      title: "D4 is selected as a fresh one-shot threshold-free metadata census",
      copy: "The user explicitly selects D4 without repairing or relabelling D3. A fresh executable contract rechecks both exact object identities, loads weights-only/mmap on CPU and writes the exact count plus ordered IDs only to a private manifest. Public-safe output is limited to aggregate metadata and an ID digest; tensor/connectivity values, WSS metrics and a scientific verdict are excluded. Six dedicated tests and 123 protocol invariants pass. Quality and a private activation manifest must precede the sole introai9 CPU 4/64 GB/GPU-0 attempt; current usage is 0/1.",
      files: ["configs/aneug_processed_v4_d4_v1.json", "src/aurora/aneug_processed_v4_d4_v1.py", "tests/test_aneug_processed_v4_d4_v1.py", "cluster/pbs_aneug_processed_v4_d4_v1.pbs", "docs/aneug-processed-v4-d4-registration-2026-08-16.md", "configs/aurora_v1.json", "src/aurora/protocol.py", "tests/test_protocol.py", "README.md", "site/index.html", "site/learn.html", "site/assets/research-data.js", "AGENTS.md", "CHANGELOG.md"]
    },
    {
      date: "2026.08.16",
      category: "protocol",
      title: "A non-executable D4 metadata census draft is falsified before selection",
      copy: "The dormant draft has no cardinality pass threshold and refuses execution while human_selected=false. Its pure census records aggregate metadata and a public ID digest while keeping ordered IDs private; sentinel tensors fail on indexing, iteration or materialization. Official builder exact case keys and mesh hierarchy are independently corroborated. Hierarchy tensors expose shape/dtype only, connectivity and field values remain unread, and scientific_verdict is null. Five synthetic tests pass. No config is registered for payload access or PBS, and D3 remains failed without backfill.",
    ...
    },
    {
      date: "2026.08.16",
      category: "research",
      title: "Static artifact semantics explains why raw 730 does not guarantee processed 730",
      copy: "The pinned official filename tree contains 730 seven-file-complete transient directories, while exact D3 evidence proves the processed registered list is below 700. The 1k tag comes from n_subdivide=1, the builder asserts no cohort cardinality and can reuse caches. Missing IDs and the historical cause remain unknown. D4 is only a recommended threshold-free metadata census and has not been selected, registered or executed.",
      files: ["results/aneug_processed_v4_semantics_s0_20260816.json", "docs/aneug-processed-v4-artifact-semantics-reappraisal-2026-08-16.md", "configs/aurora_v1.json", "src/aurora/protocol.py", "tests/test_protocol.py", "README.md", "site/index.html", "site/learn.html", "site/assets/research-data.js", "AGENTS.md", "CHANGELOG.md"]
    },
    {
      date: "2026.08.16",
      category: "data",
    ...
    },
    {
      date: "2026.08.14",
      category: "data",
      title: "D2 steady v4 completes exact in the first client session",
      copy: "The temporary steady normalization source completed at exactly 9,632,510,050 bytes and its full SHA-256 matches official 0c03c1d9…0177f. No payload was parsed. Server objects remain 0/2, transient sessions 0 and schema/science 0. The next bounded action is exact SFTP staging followed by server-size verification and deletion of the client steady copy.",
      files: ["results/aneug_processed_v4_d2_transport_20260814.json", "configs/aurora_v1.json", "src/aurora/protocol.py", "tests/test_protocol.py", "docs/aneug-processed-v4-client-staging-d2-2026-08-14.md", "README.md", "AGENTS.md", "CHANGELOG.md"]
    },
    {
      date: "2026.08.14",
      category: "protocol",
      title: "Client-staged D2 replaces compute-node egress without repairing D1",
      copy: "Both official v4 identities are reachable from the client. A discarded 67,108,864-byte HTTP-206 probe measured 5,697,265 B/s without persistence or parsing. D2 stages steady then transient sequentially through exact client download and Windows OpenSSH SFTP, never compute/login-node external download. Client cap is 30 GB, server peak 33.38 GB and maximum simultaneous new bytes 57.12 GB. Only one introai9 CPU/PBS checksum/schema attempt exists after exact server-size preflight; scientific P0, model, GPU and claim remain zero.",
      files: ["configs/aneug_processed_v4_client_stage_d2.json", "src/aurora/aneug_processed_v4_d2.py", "tests/test_aneug_processed_v4_d2.py", "cluster/pbs_aneug_processed_v4_d2.pbs", "docs/aneug-processed-v4-client-staging-d2-2026-08-14.md", "configs/aurora_v1.json", "README.md", "AGENTS.md", "CHANGELOG.md"]
    },
    {
      date: "2026.08.14",
      category: "experiment",
      title: "Processed-v4 D1 closes after the final compute-node transport timeout",
      copy: "Quality/Pages-passed source 274bb0e… ran as final introai9 job 116209.ECE-util1 with CPU 4, 64 GB and GPU 0. It finalized F/exit 28 after 00:07:32; persistent curl evidence is a 30,001 ms connection timeout. Partial bytes, transport-complete marker, reader and schema are zero. D1 is closed at 3/3 with no repair or fourth attempt. This does not invalidate the official objects or 60 GB plan and is not a data/scientific verdict.",
      files: ["results/aneug_processed_v4_d1_execution_20260814.json", "configs/aurora_v1.json", "src/aurora/protocol.py", "tests/test_protocol.py", "docs/aneug-processed-v4-storage-bounded-acquisition-2026-08-14.md", "README.md", "AGENTS.md", "CHANGELOG.md"]
    },
    {
      date: "2026.08.14",
      category: "experiment",
      title: "D1 attempt 2 isolates a curl-7.58 compatibility failure before any byte",
      copy: "Introai9 job 116208.ECE-util1 used CPU 4, 64 GB and GPU 0. Its persistent log proves curl 7.58.0 rejected the unsupported --retry-all-errors option before a partial object existed; reader and schema remain untouched. Final attempt 3 replaces only that option with curl-7.58-compatible retry flags. Exact objects, hashes, 60 GB cap, schema and scientific boundaries do not change, and there is no fourth D1 transport attempt.",
      files: ["cluster/pbs_aneug_processed_v4_d1.pbs", "configs/aurora_v1.json", "src/aurora/protocol.py", "tests/test_protocol.py", "docs/aneug-processed-v4-storage-bounded-acquisition-2026-08-14.md", "README.md", "AGENTS.md", "CHANGELOG.md"]
    },
    {
      date: "2026.08.14",
      category: "experiment",
    ...
    },
    {
      date: "2026.08.14",
      category: "data",
      title: "Processed-v4 D1 replaces the unnecessary 2 TB raw-download plan",
      copy: "The exact official transient v4 object is 23,744,862,051 bytes and becomes the sole persistent full target. Official assembler code shows its physical-unit normalization comes from steady v4, so the exact 9,632,510,050-byte steady object is temporary and is deleted after label/tensor_norm extraction. Peak new processed storage is 33,377,372,101 bytes under a 60 GB cap. V5, raw per-case blood/wall, 14,000-case steady CFD and cfd are forbidden. D1 checks weights-only schema, at least 700 unique cases, 80 phases, vector WSS, mesh order and local geometry linkage. It is acquisition—not scientific P0, model training or paper evidence.",
      files: ["configs/aneug_processed_v4_acquisition_d1.json", "src/aurora/aneug_processed_v4_d1.py", "tests/test_aneug_processed_v4_d1.py", "cluster/pbs_aneug_processed_v4_d1.pbs", "docs/aneug-processed-v4-storage-bounded-acquisition-2026-08-14.md", "configs/aurora_v1.json", "src/aurora/protocol.py", "tests/test_protocol.py", "README.md", "site/index.html", "site/learn.html", "site/assets/research-data.js", "AGENTS.md", "CHANGELOG.md"]
    },
    {
      date: "2026.08.14",
      category: "experiment",
    ...
    },
    {
      ...
      copy: "Administrator-reported recovery was verified by public-key login, an empty user queue, enabled/running coss_agpu, exact cache size and SHA-256, and readable Singularity 3.11.3 storage. The base image has NumPy 2.1.2 and PyTorch 2.5.1 but no h5py, so a pinned wheel is installed network-free into job-local storage. Final binary preflight also found no Git executable, and an exact wrapper dry-run found that renaming the wheel mount to h5py.whl violates wheel parsing; no P0 was submitted in either case. Schema v3 passes the host-verified clean commit into the container, preserves the registered wheel basename, rejects mismatch and pins the superseded pre-attempt manifest with attempt/field-read zero. Immutable scientific config/evaluator bytes and all 12 gates are unchanged. HDF5 array read, PBS attempt, GPU, result and claim remain zero; junjinyong remains excluded.",
    ...
    },
    {
      ...
      files: ["README.md", "scripts/check_site.py", "site/assets/research-data.js", "AGENTS.md", "CHANGELOG.md"]
    },
    {
      date: "2026.08.13",
      category: "research",
      title: "PaNO, NOEM and cardiovascular BC tuning remove the broad method story",
      copy: "PaNO already shows that global field accuracy can disagree with a downstream readout and proposes readout alignment; NOEM formulates generic hard-constraint neural-operator output transforms; and a differentiable cardiovascular ROM uses one high-fidelity CFD solve for repeated BC tuning. AURORA therefore retains 32.5/40 without increase only for an Aneumo-specific bilateral field-error-matched audit, learned-direct and train-fitted power-law controls, and exactly 100 new families excluding historical 32. RF-C2 is a controlled application solution, not algorithmic novelty. Real P0 v3 remains 0/12 and no method name, server action, PBS/GPU result or claim opened.",
      files: ["configs/aneumo_response_fidelity_latest_collision_recheck_v1.json", "tests/test_aneumo_response_fidelity_latest_collision_recheck_v1.py", "docs/aneumo-response-fidelity-latest-collision-recheck-2026-08-13.md", "README.md", "docs/research-direction.md", "docs/isbi-2027-plan.md", "docs/experiment-protocol.md", "docs/literature-lineage.md", "site/index.html", "site/learn.html", "site/assets/research-data.js", "AGENTS.md", "CHANGELOG.md"]
    },
    {
      date: "2026.08.13",
      category: "site",
    ...
    },
    {
      ...
      category: "deployment",
      title: "P1 v2 and the private no-claim ledger are synchronized",
      copy: "Exact scientific public source 8b288c0… passed Quality 31601736993 and Pages 31601736273. Private planning head 83fc8861… is remote exact, PRIVATE and anonymously 404; main.tex and references remain byte-for-byte unchanged. Real P0 remains 0/11, P1 remains unregistered and no server/PBS/GPU action occurred.",
      files: ["README.md", "AGENTS.md", "CHANGELOG.md", "site/assets/research-data.js"]
    },
    {
      date: "2026.08.12",
    ...
    },
    {
      ...
      files: ["results/aneurisk_conformal_degree_p0_execution_20260811.json", "configs/aurora_v1.json", "src/aurora/protocol.py", "tests/test_protocol.py", "README.md", "AGENTS.md", "docs/conformal-degree-certificate-source-audit-2026-08-11.md", "docs/research-direction.md", "docs/model-spec.md", "docs/literature-lineage.md", "docs/experiment-protocol.md", "docs/datasets.md", "docs/isbi-2027-plan.md", "docs/server-execution.md", "site/index.html", "site/learn.html", "site/assets/research-data.js", "CHANGELOG.md"]
    },
    {
      date: "2026.08.11",
      category: "research",
    ...
    },
    {
      date: "2026.08.10",
      category: "experiment",
      title: "Schema 6.9 closes the OpenNeuro containment P0 without a scientific verdict",
      copy: "Exact public source bb227edc… ran once on introai9 as CPU-only PBS job 115622 and finished F/exit 1 after 2:24. Only a 310-byte private incomplete status materialized; aggregate result and raw PBS output are absent, so 0/10 registered checks were evaluated. The 32.5/40 source formulation is preserved as closed history, not promoted to novelty or a negative result. Same-contract repair/rerun, P1, patient payload, method, architecture, GPU and outer test remain forbidden. Active shortlist and paper identity return to zero; junjinyong was not accessed and remains prohibited.",
      files: ["results/openneuro_containment_morphometry_p0_execution_20260810.json", "configs/aurora_v1.json", "src/aurora/protocol.py", "tests/test_protocol.py", "README.md", "AGENTS.md", "docs/research-direction.md", "docs/model-spec.md", "docs/experiment-protocol.md", "docs/datasets.md", "docs/server-execution.md", "docs/isbi-2027-plan.md", "docs/literature-lineage.md", "docs/data-acquisition.md", "site/index.html", "site/learn.html", "site/assets/research-data.js"]
    },
    {
      date: "2026.08.10",
      category: "research",
    ...
    },
    {
      date: "2026.08.08",
      category: "result",
      title: "V1c passes geometry staging; V1d seals test-free development caching",
      copy: "Exact source 84fc244의 V1c는 20 train representatives, 60 patches, 180 payloads를 감사해 8/8을 통과했다. 60/60 patch가 세 flow에서 exact invariant였고 minimum polygon-valid fraction은 1.0이었다. Field arrays와 validation/test payload는 읽지 않았다. V1d는 validation geometry decode 전에 train 40·validation 12·test 0 case의 520 geometry payload를 고정해 q-invariance, topology/frame, bounds와 exact boundary-volume correspondence를 검사한다. Pass도 known-condition strong-baseline protocol만 허용한다.",
      files: ["results/aneumo_isbi_v1c_boundary_geometry_staging_audit_20260808.json", "configs/aneumo_isbi_v1d_development_geometry_cache.json", "src/aurora/aneumo_isbi_v1d_development_geometry.py", "experiments/run_aneumo_isbi_v1d_development_geometry.py", "tests/test_aneumo_isbi_v1d_development_geometry.py", "AGENTS.md", "README.md", "docs/research-direction.md", "docs/model-spec.md", "docs/experiment-protocol.md", "docs/isbi-2027-plan.md", "docs/datasets.md", "docs/server-execution.md", "results/README.md", "configs/aurora_v1.json", "src/aurora/protocol.py", "tests/test_protocol.py", "site/learn.html", "site/assets/research-data.js", "CHANGELOG.md"]
    },
    {
      date: "2026.08.08",
      category: "result",
