window.AURORA_DATA = Object.freeze({
  venue: {
    ...
    status: "Target locked · no active paper identity · transient structure-faithful WSS 30.0/40 inactive · D0 v2 execution complete with private aggregate and raw stage deleted · scientific stability unevaluated · family-disjoint P0 v1 registered non-executable pending authoritative licence resolution · P0 field/result/method/model/GPU/validation/test/outer test/claim 0 · not submission-ready",
    requirement: "D0 v2 reused only two previously inspected case-1 members, completed with zero PBS HTTP and deleted its raw stage. Registered P0 v1 excludes the D0 family and field-blindly freezes 12 distinct families, one canonical complete case per family and five phases, but stages zero of 60 future members while the Hugging Face and GitHub licence declarations conflict. Its count, signed spatial recall, tangency and perturbation gates are non-compensatory; Hodge, GNN, equivariance, edge forms, tracking and topology preservation remain direct priors or controls",
  ...
  lineage: [
    {
      ...
      copy: "The closed response-fidelity P0 is not repaired. A fresh direct-prior subtraction includes Hodge Spectral Duality, SE(3) artery-wall WSS networks, RHSIA, exact critical-point-trajectory compression, FaCTz and a 359-lesion aneurysm critical-point study. GNN, Hodge, edge 1-forms, temporal decoding, tracking and topology losses are therefore controls rather than novelty. The remaining application conjunction is robust target identification, field-error/compute-matched structural failure and a minimal mechanism-linked correction. It stays 30.0/40 inactive. D0 reuses only case 1 phases 4.01 and 5.00. V1 job 116160.ECE-util1 ended execution-incomplete before any VTP payload because compute-node networking was unreachable. Final v2 job 116165.ECE-util1 used exact ephemeral private staging, zero PBS HTTP and GPU 0, completed in 25 seconds and deleted the raw stage. Detailed field-derived aggregate remains private. Scientific stability is still unevaluated; family-disjoint P0 v1 is registered metadata-only and non-executable pending authoritative licence resolution. Closed response-fidelity P0 v3 remains execution-incomplete with 0/12 scientific checks evaluated. No further D0 repair, scientific P0 result, model or claim is active.",
      status: "Active paper identity 0 · transient 30.0/40 inactive · D0 v2 complete / stability unevaluated · P0 v1 registered non-executable · field/model/GPU/test/claim 0",
      url: "../docs/aneumo-transient-structure-reentry-2026-08-13.md"
    },
    {
      year: "2026.08",
      title: "Stability P0 freezes a family-disjoint falsifier but cannot execute",
      copy: "Official Connection.csv and release-directory metadata select 12 distinct non-D0 families, one canonical complete case per family and five phases before any P0 field read. Each phase must pass informative-structure, tangency, pairwise signed spatial recall, count/index and deterministic 1%-RMS tangent-perturbation gates without compensation; 10/12 families must pass at least 4/5 phases. The exact release is declared CC BY-NC-ND 4.0 on Hugging Face and CC BY 4.0 in the GitHub datasheet. Stricter private handling is not authoritative resolution, so v1 keeps staging and execution false, with field/model/GPU/result/claim 0.",
      status: "Registered metadata-only · 12 families / 60 future members · staged 0 · execution false · licence clarification required",
      url: "../docs/aneumo-transient-structure-stability-p0-v1-2026-08-13.md"
    },
    {
      year: "2026.08",
