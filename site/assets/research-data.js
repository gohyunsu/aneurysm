window.AURORA_DATA = Object.freeze({
  venue: {
    ...
    status: "Target locked · no active paper identity · transient structure-faithful WSS 30.0/40 inactive · D0 reader/extractor development only · v1 transport-incomplete before VTP · final transport repair 2/2 prospective · scientific P0/method/model/GPU/validation/test/outer test/result/claim 0 · closed response-fidelity P0 v3 remains execution-incomplete with 0/12 scientific checks evaluated · not submission-ready",
    requirement: "D0 v1 ended execution-incomplete before any VTP payload because compute-node outbound network was unreachable. Final D0 v2 reuses only two previously inspected case-1 wall members through exact ephemeral private staging, performs zero PBS HTTP requests and allows no further repair; it is not target-stability evidence and can only authorize a separately registered family-disjoint method-free P0; Hodge, GNN, equivariance, edge forms, tracking and topology preservation remain direct priors or controls",
