window.AURORA_DATA = Object.freeze({
  venue: {
    ...
    status: "Target locked · no active paper identity · transient structure-faithful WSS 30.0/40 inactive · D0 reader/extractor development only · v1 transport-incomplete before VTP · v2 execution complete with private aggregate and raw stage deleted · scientific stability unevaluated · P0/method/model/GPU/validation/test/outer test/result/claim 0 · closed response-fidelity P0 v3 remains execution-incomplete with 0/12 scientific checks evaluated · not submission-ready",
    requirement: "D0 v1 ended execution-incomplete before any VTP payload because compute-node outbound network was unreachable. Final D0 v2 reused only two previously inspected case-1 wall members through exact ephemeral private staging, performed zero PBS HTTP requests, completed and deleted the raw stage. Detailed field-derived aggregate remains private under the stricter licence boundary; D0 is not target-stability evidence and can only authorize a separately registered family-disjoint method-free P0; Hodge, GNN, equivariance, edge forms, tracking and topology preservation remain direct priors or controls",
  ...
  lineage: [
    {
      ...
      copy: "The closed response-fidelity P0 is not repaired. A fresh direct-prior subtraction includes Hodge Spectral Duality, SE(3) artery-wall WSS networks, RHSIA, exact critical-point-trajectory compression, FaCTz and a 359-lesion aneurysm critical-point study. GNN, Hodge, edge 1-forms, temporal decoding, tracking and topology losses are therefore controls rather than novelty. The remaining application conjunction is robust target identification, field-error/compute-matched structural failure and a minimal mechanism-linked correction. It stays 30.0/40 inactive. D0 reuses only case 1 phases 4.01 and 5.00. V1 job 116160.ECE-util1 ended execution-incomplete before any VTP payload because compute-node networking was unreachable. Final v2 job 116165.ECE-util1 used exact ephemeral private staging, zero PBS HTTP and GPU 0, completed in 25 seconds and deleted the raw stage. Detailed field-derived aggregate remains private. Scientific stability is still unevaluated; P0 must be separately registered before a new field read. No further D0 repair, scientific P0, model or claim is active.",
      status: "Active paper identity 0 · transient 30.0/40 inactive · D0 v2 execution complete / stability unevaluated · P0/model/GPU/test/claim 0",
